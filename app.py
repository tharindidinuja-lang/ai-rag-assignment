...
from pathlib import Path  # Add this - you're missing it!
from langchain_experimental.text_splitter import SemanticChunker  # Change this
...
def split_documents(documents):
    ...
    splitter = SemanticChunker(
        ...
        breakpoint_threshold_amount=95,  # Adjust this value (90-99)
    )
    chunks = splitter.split_documents(documents)
    st.info(f"Created {len(chunks)} semantic chunks from {len(documents)} pages")
    return chunks
